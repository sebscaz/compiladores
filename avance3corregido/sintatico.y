...
DECLARACIONFUNCION: crear TIPO id {numeroDimension=0;
...
ASIGNACION2: {numeroDimension=1;}  ARREGLOSASIG  {hacerPush=1;} 
	|/*vacio*/;
ARREGLOSASIG: corchetea EXP {generarVerifica();} corchetec ARREGLOSASIG2;
...
CREARFUNCION: funcion CREARFUNCION2 id {numeroParametros=0;
